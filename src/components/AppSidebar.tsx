...
import { Calendar, Users, Building2, DollarSign, Package, BarChart, Settings, LayoutDashboard, Plus } from "lucide-react"
            ...
            <div className="mt-8 px-3">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <div className="space-y-3">
                  <button 
                    className="w-full text-left text-sm p-3 rounded-lg hover:bg-white/20 flex items-center gap-3 text-white/90 hover:text-white transition-all duration-200"
